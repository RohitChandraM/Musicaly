...
function SinglePlayer({ label, src, accentColor = "purple" }) {
  ...
  const colors = {
    purple: { btn: "bg-purple-600 hover:bg-purple-500", bar: "bg-purple-500" },
    emerald: { btn: "bg-emerald-600 hover:bg-emerald-500", bar: "bg-emerald-500" },
  };
  ...
  return (
    <div className="bg-white/5 rounded-xl p-4 border border-white/10">
      ...
      <div className="flex items-center gap-3">
        <button
          onClick={toggle}
          className={`w-10 h-10 rounded-full ${c.btn} flex items-center justify-center text-white shrink-0 transition-colors`}
        >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div
            className="h-1.5 rounded-full bg-white/10 cursor-pointer relative overflow-hidden"
            onClick={seek}
          >
            <div
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {originalSrc && (
          <SinglePlayer label="Original" src={originalSrc} accentColor="purple" />
        )}
        {processedUrl && (
          <SinglePlayer label="Humanized" src={processedUrl} accentColor="emerald" />
        )}
      </div>
    </div>
  );
